...
class LockedUserPointSpendServiceIntegrationTest {

    @Autowired
    private LockedUserPointSpendService sut;
    ...
    @Test
    @DisplayName("단일 사용자가 요청한 만큼 포인트가 지불된다")
    void spend1() {
        // given
        int threadCount = 10;
    ...
    @Test
    @DisplayName("여러 사용자가 요청하면 각자 자기 몫만큼 포인트가 지불된다")
    void spend2() {
        // given
        int threadCount = 10;
